...
router.get("/hardwareshops", userController.getHardwareshops);

router.get("/hardwareshop/:restId", userController.getHardwareshop);
...
router.get(
  "/hardwareshops-location/:lat/:lng",
  userController.getHardwareshopsByAddress
);
