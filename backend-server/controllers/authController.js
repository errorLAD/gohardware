  ...
  bcrypt
    ...
    .then((savedUser) => {
      transporter.sendMail({
        to: email,
        from: "",
        subject: "Verify your Account on goHardware.in ",
        html: `
                      <p>Please verify your email by clicking on the link below - goHardware.in</p>
  ...
  bcrypt
    ...
    .then((savedSeller) => {
      transporter.sendMail({
        to: email,
        from: "",
        subject: "Verify your Account on goHardware",
        html: `
                      <p>Please verify your email by clicking on the link below -goHardware</p>
                      <p>Click this <a href="http://localhost:3002/auth/verify/${token}">link</a> to verify your account.</p>
                    `,
      });
      res.status(201).json({
