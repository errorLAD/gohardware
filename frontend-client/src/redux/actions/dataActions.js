...
export const fetchHardwareshops = () => (dispatch) => {
  dispatch({ type: LOADING_DATA });
  axios
    .get("/hardwareshops")
    .then((res) => {
      dispatch({
        type: SET_HARDWARESHOPS,
        payload: res.data,
      });
    })
    .catch((err) => {
...
export const fetchHardwareshopsByAddress = (lat, lng) => (dispatch) => {
  dispatch({ type: LOADING_DATA });
  axios
    .get(`/hardwareshops-location/${lat}/${lng}`)
    .then((res) => {
      dispatch({
        type: SET_HARDWARESHOPS,
        payload: res.data,
...
export const fetchHardwareshop = (restId) => (dispatch) => {
  dispatch({ type: LOADING_DATA });
  axios
    .get(`/hardwareshop/${restId}`)
    .then((res) => {
      dispatch({
        type: SET_HARDWARESHOP,
        payload: res.data,
      });
    })
    .catch((err) => {
