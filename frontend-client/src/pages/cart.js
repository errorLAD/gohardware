...
const Cart = (props) => {
      ...
      {loading ? (
        ...
        <>
          ...
          <Grid container direction="row" spacing={2}>
            ...
            <Grid item sm={3}>
            <div class="shadow-2xl bg-red-100 rounded-xlg">
                <div style={{ marginLeft: 20, marginRight: 20 }}>
                  ...
                  {step === 1 && (
                    <div variant="body2" color="textPrimary">
                      <div className={classes.spaceTypo}>
                        <span class="">Initial amount</span>
                        <span>Rs. {price}</span>
                      </div>
                  ...
                  <Typography gutterBottom variant="h5" noWrap>
                    <div className={classes.spaceTypo}>
                      ...
                      <span class="text-black">Rs. {price + deliveryCharge}</span>
                    </div>
                  </Typography>
                  </div>
                  {step === 1 && (
  ...
  {loading ? (
        ...
        <>
          ...
          <span class="tag is-warning is-light  py-4 px-4">
          ...
          {step === 2 && (
            <MyButton tip="Go Back" onClick={prevStep}>
              ...
              >
                <div style={{ marginLeft: 20, marginRight: 20 }}>
                  <br />
                  <div class="text-xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                    {step === 1 && "Total Amount"}
                    </div>
                    <div class="text-xl py-2 leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                     {step === 2 && "Order Summary"}
                  </div>
                  {step === 1 && (
                    <div variant="body2" color="textPrimary" class="py-4">
                      <div className={classes.spaceTypo}>
                        <span class="px-4">Initial amount</span>
                        <span>Rs. {price}</span>
                      </div>
