...
const Orders = (props) => {
  ...
  return (
    <>
      ...
      <h2 class=" max-w-4xl text-xl font-bold tracking-tight text-gray-900 sm:text-2xl">
      <span class="block"><span class="tag is-link is-light is-medium">Order History</span>
       </span>
      </h2>
      </Typography>
            ...
            {orders ? (
              orders.length > 0 ? (
                orders.map((order) => (
                 ...
                 <span class=" py-12">
                   <span class="tag is-warning is-light w3-center">
