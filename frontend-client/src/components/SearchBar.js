...
import { fetchHardwareshopsByAddress } from "../redux/actions/dataActions";
...
export default function CustomizedInputBase(props) {
  ...
  const fetchRestByLocation = (latlng) => {
    dispatch(fetchHardwareshopsByAddress(latlng.lat, latlng.lng));
    props.action(true);
  };
  ...
  return (
    ...
    <div class=" py-2 bg-indigo-100 max-w-2xl mx-auto  rounded-xl flex items-center space-x-8">
    <div
...
<div class=" py-2 bg-indigo-100 max-w-2xl mx-auto  rounded-xl flex items-center space-x-8">
    <div
      ...
      component="form"
      className={page !== "items" ? classes.rootHomes : classes.rootItems}
    >
      {page === "home" && <LocationOn className={classes.iconButton} />}
